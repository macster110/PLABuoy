...
public interface MovementSensor {
	 ...
	 * @return the orientation of the sensor  in Euler angles (heading, pitch and roll) in RADIANS. Angle is can be null
	 * if doesn't exist e.g. (an inclinometer might only have pitch and roll)
	 * 
	 */
