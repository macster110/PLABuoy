...
public class Hydrophone {
	 ...
	 */
	private final ObjectProperty<HArray> parentArray=new SimpleObjectProperty<HArray>(); 
	...
	public HArray getParentArray() {
		return parentArray.getValue();
	}

	public void setParentArray(HArray parentArray) {
