...
/**
 * Basically a quaternion is a vector which can encode three dimensional orientation information (e.g. heading, pitch and roll). Means we can get rid of Euler angles if we want to. 
 * This particular qauternion calss assumes that the heading rotates around the z-axis, pitch rotates around the x-axis and roll rotates around the y-axis. 
 * <p>
 ...
 * Compared to rotation matrices they are more numerically stable and may be more efficient. Quaternions have found their way into applications in computer graphics, computer vision, robotics, navigation, molecular dynamics, flight dynamics,[1] and orbital mechanics of satellites
 * <p>
 * Code is heavily based on code from Prasanna Velagapudi.  Copyright (c) 2008, Prasanna Velagapudi <pkv@cs.cmu.edu>. Permission to use, modify and distribute. 
 * <p> 
 * Note: this is copied directly from PAMGUARD which copied and modified code from Prasanna Velagapudi.  Copyright (c) 2008.
 * 
 * @author Prasanna Velagapudi. Modified by Jamie Macaulay to use Jama.
 */
...
public class Quaternion implements Cloneable, Serializable {
    ...
    /**
     * Create a quartenion from euler angles. The euler angles must be 
     * @param eulerAnlges- these are the euler angles in RADIANS. 
     */
    public Quaternion(double heading, double pitch, double roll) {
...
//        // This is a test for singularities
        ...
        else heading=2*Math.PI-heading;
